...
function SubsidyManagement({ onCreateNew, onExport }: ToolProps) {
  ...
  const allSubsidies = [
    ...
    { id: 6, name: "東京都木造住宅耐震改修助成事業", category: "耐震改修", amount: "最大150万円", deadline: "2026/12/28", jurisdiction: "東京都", pref: "東京都", status: "受付中", keywords: ["耐震","木造","補強","改修","東京"], totalBudget: 5000000000, usedBudget: 1750000000 },
    { id: 7, name: "世田谷区住宅リフォーム助成", category: "リフォーム", amount: "最大20万円", deadline: "2026/09/30", jurisdiction: "世田谷区", pref: "東京都", status: "受付中", keywords: ["リフォーム","助成","世田谷","バリアフリー"], totalBudget: 200000000, usedBudget: 120000000 },
    { id: 8, name: "東京都ZEH導入補助金", category: "新築", amount: "最大70万円", deadline: "2026/06/30", jurisdiction: "東京都", pref: "東京都", status: "準備中", keywords: ["ZEH","ゼッチ","新築","省エネ","東京"], totalBudget: 3000000000, usedBudget: 0 },
    { id: 9, name: "東京都既存住宅省エネ改修助成", category: "省エネ改修", amount: "最大300万円", deadline: "2026/09/30", jurisdiction: "東京都", pref: "東京都", status: "受付中", keywords: ["省エネ","改修","既存住宅","東京","断熱"], totalBudget: 3000000000, usedBudget: 1800000000 },
    ...
    { id: 16, name: "練馬区住宅リフォーム補助金", category: "リフォーム", amount: "最大30万円", deadline: "2026/07/31", jurisdiction: "練馬区", pref: "東京都", status: "受付中", keywords: ["リフォーム","練馬","助成","バリアフリー"], totalBudget: 150000000, usedBudget: 75000000 },
    { id: 17, name: "品川区住宅耐震改修助成金", category: "耐震改修", amount: "最大150万円", deadline: "2026/12/28", jurisdiction: "品川区", pref: "東京都", status: "受付中", keywords: ["耐震","品川","木造","補強"], totalBudget: 300000000, usedBudget: 90000000 },
